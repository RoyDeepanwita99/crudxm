...
<body  style="background-color:#f1f2f6">	
	<center style="background-color:#95afc0;  "  >
		...
		<form  method="POST" action="index.php">
			...
			<input style="background-color:#dff9fb; border-radius:15px;" type="text" placeholder="Enter name" name="f_username"required > <br> <br>
			<label>Password</label>
			<input style="background-color:#dff9fb; border-radius:15px;"type="text" placeholder="Enter password" name="f_password"required  > <br> <br>
			
			<input style="background-color:#e056fd; border-radius:15px;" type="submit" value="Log in" name="login">
		</form>
		 Don't have an account?<a href="register.php"><button style="background-color:#e056fd; border-radius:15px;">Register</button> </a> 
	</center>	
